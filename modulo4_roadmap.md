...
| :--- | :--- | :--- | :--- | :--- |
| Nível 121 | Verificando Interfaces de Rede: O Inventário do Que Existe | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 122 | Roteamento e Tabela de Rotas: Como os Pacotes Viajam | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 123 | Diagnóstico de Conectividade: A Prova de Vida da Rede | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 124 | Rastreamento de Pacotes: Seguindo a Trilha | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 125 | Resolução de Nomes e DNS: Traduzindo Endereços | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 126 | Download de Arquivos via Linha de Comando | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 127 | Conexão SSH Segura: O Túnel Criptografado | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 128 | Cópia Segura de Arquivos: Movendo Dados Remotamente | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 129 | Regras Básicas de Firewall com UFW | ⏳ Planejado | ❌ Pendente | ❌ Pendente |
| Nível 130 | [Desafio Integrado] O Filial Offline | ⏳ Planejado | ❌ Pendente | ❌ Pendente |

---

## 2. Metas de Implementação

- [ ] Criar imagem Docker para os desafios (`saoluis-network:broken` com rede simulada)
- [ ] Escrever validadores Python para cada etapa do desafio integrado (nível 130)
- [ ] Gerar assets visuais (prompts para Meta AI / Stable Diffusion)
- [ ] Criar rede Docker interna com dois containers (matriz + filial) para simular ambiente real
- [ ] Implementar servidor DNS fake com bind9 para simular falha de registro
- [ ] Configurar UFW no container da filial com porta bloqueada como pré-condição do desafio
...
| :--- | :--- | :--- |
| `saoluis_warehouse.png` | Galpão da distribuidora com servidores rack e monitores de rastreamento | ❌ Pendente |
| `caruaru_filial.png` | Escritório da filial em Caruaru com rede caída (telas de erro) | ❌ Pendente |
| `network_topology.png` | Diagrama visual da topologia de rede da distribuidora | ❌ Pendente |
| `aura7_network.png` | AURA-7 analisando pacotes de rede com visualização de roteamento | ❌ Pendente |
| `badge_elo_da_rede.png` | Badge de conclusão do Módulo 4 | ❌ Pendente |
