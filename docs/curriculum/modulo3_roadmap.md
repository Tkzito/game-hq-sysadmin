...
| :--- | :--- | :--- | :--- | :--- |
| Nível 111 | Processos em Execução: Quem Está Rodando Aqui? | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 112 | Monitoramento Interativo com htop | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 113 | Enviando Sinais a Processos: A Arte de Encerrar com Elegância | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 114 | Verificando Consumo de Memória: O que a RAM Esconde | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 115 | Uso de Disco por Partição: Mapeando o Território | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 116 | Identificando os Maiores Consumidores de Espaço | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 117 | Jobs em Background: Multitarefa no Terminal | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 118 | Rastreando Arquivos Abertos por Processo | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 119 | Prioridade de Execução: Quem Passa na Frente | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |
| Nível 120 | [Desafio Integrado] O Servidor da Clínica | ✅ Concluído | ✅ Disponível | ✔️ Mapeado |

---

## 2. Metas de Implementação

- [x] Criar imagem Docker para os desafios (`oraltech-server:broken` com load simulado)
- [x] Escrever validadores Python para cada etapa do desafio integrado (nível 120)
- [x] Gerar assets visuais (prompts para Meta AI / Stable Diffusion)
- [x] Criar script de setup que simula servidor doente (processo CPU hog + disco cheio + swap alto)
- [x] Implementar sistema de dica progressiva (AURA-7 sugere próximo passo após 60s de inatividade)
- [x] Criar banco de dados de processos fictícios da OralTech (`radiologia_sync`, `dental_agenda`, `backup_dicom`)
...
| :--- | :--- | :--- |
| `oraltech_reception.png` | Hall de recepção da clínica com monitores exibindo erro | ✅ Disponível |
| `aura7_diagnostic.png` | AURA-7 em modo de análise com gráficos de CPU | ✅ Disponível |
| `server_room_clinic.png` | Sala de servidores em rack da clínica odontológica | ✅ Disponível |
| `htop_oraltech.png` | Screenshot simulado do htop com dados da OralTech | ✅ Disponível |
| `badge_medico_servidores.png` | Badge de conclusão do Módulo 3 | ✅ Disponível |
