...
- Realizar rodadas de testes manuais e checagem de usabilidade local.
- Estudar a implementação de suporte internacional (Português / Inglês) para maior acessibilidade do game.
- Preparar o repositório git para o commit final de todas as mudanças locais.
